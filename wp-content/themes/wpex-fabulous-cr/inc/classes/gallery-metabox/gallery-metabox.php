...
if ( ! class_exists( 'WPEX_Gallery_Metabox' ) ) {
	class WPEX_Gallery_Metabox {
		...
		public function __construct() {
			...
			$this->dir	= get_template_directory_uri() .'/inc/meta/gallery-metabox/';
									 ...
									 $wpex_gallery_images.append('\
										<li class="image" data-attachment_id="' + attachment.id + '">\
											<div class="attachment-preview">\
											   ...
											   <a href="#" class="wpex-gmb-remove" title="<?php esc_attr_e( 'Remove image', 'wpex' ); ?>"><div class="media-modal-icon"></div></a>\
											</div>\
										</li>');
								}
							} );
